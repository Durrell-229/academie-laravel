...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <meta name="description" content="Embark on a limitless learning journey with Academie Numerique, the ultimate Learning Management System (LMS). Access diverse courses, learn from experts, and cultivate valuable skills effortlessly. Discover boundless opportunities to grow and thrive. Get started now!" />
    ...
    <title>
      ...
      @endif
      | {{ config('app.name', 'Laravel') }} - {{ config('app.tagline') }}
    </title>
    <!-- Favicon -->
